...
path "stakeholders_abe_engine/medutils/addattributes" {
    capabilities = ["create", "update"]
}

# Allow a token to generate new keys for an object
path "stakeholders_abe_engine/keygen/medutils/*" {
    capabilities = ["create", "update"]
}
...
path "stakeholders_abe_engine/syskeygen/+/medutils" {
    capabilities = ["create", "update"]
}
...
path "stakeholders_abe_engine/sysdecrypt/medutils/*" {
    capabilities = ["create", "update"]
}
