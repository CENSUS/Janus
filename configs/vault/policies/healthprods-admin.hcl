...
path "stakeholders_abe_engine/healthprods/addattributes" {
    capabilities = ["create", "update"]
}

# Allow a token to generate new keys for an object
path "stakeholders_abe_engine/keygen/healthprods/*" {
    capabilities = ["create", "update"]
}
...
path "stakeholders_abe_engine/syskeygen/+/healthprods" {
    capabilities = ["create", "update"]
}
...
path "stakeholders_abe_engine/sysdecrypt/healthprods/*" {
    capabilities = ["create", "update"]
}
