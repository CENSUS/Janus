...
import { DATA_01ValidationForm } from "../../../../../utils/processors/forms/input-validators/dataIdsValidationForm";
...
const Form = withFormik({
    ...
    mapPropsToValues: (props) => {
        const { uuid, serial, organization } = props;
        return {
            uuid: uuid || "",
            serial: serial || "",
    ...
    validationSchema: yup.object().shape(DATA_01ValidationForm),
