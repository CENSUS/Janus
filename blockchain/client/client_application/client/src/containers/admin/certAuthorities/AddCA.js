...
import component from "../../../components/modules/admin/AddCA";
import { addCARequest } from "../../../redux/actions/AdminActions";
...
const mapDispatchToProps = (dispatch) => {
  return bindActionCreators({ addCARequest }, dispatch);
};
