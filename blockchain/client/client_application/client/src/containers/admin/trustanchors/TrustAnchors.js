...
import component from "../../../components/modules/admin/UpdateTrustAnchors";
import { updateTrustAnchorsRequest } from "../../../redux/actions/AdminActions";
...
const mapDispatchToProps = (dispatch) => {
  return bindActionCreators({ updateTrustAnchorsRequest }, dispatch);
};
