...
class RecordManager extends StateConnector {
    ...
    async queryInstanceWithSelectorAndPagination(query, pageSize, bookmark) {
        return this.getPaginatedStateWithQuery(query, pageSize, bookmark);
    }

    async getPaginatedStateWithCompositeKey(compKey, pageSize, bookmark) {
        return this.getPaginatedStateWithComposite(compKey, pageSize, bookmark);
    }
